...
- **本セッション小計=確実な改善2件**（cycle1 RSS feed 新設 `4cca8f3` / cycle2 記事ページ autodiscovery `cb64a83`）。残vein（要吟味・thin寄り）: 区分別フィード・Atom/JSON Feed 併設・可視 RSS リンク（UI）は量産/scope リスクで着手は要吟味。
