...
最終更新: 2026-04-25（Phase 3 完了 — SC/ES/PM 追加）
...
| SC   | 2024 春 | 記述式 | 1 大問（5設問） | キュレーション完了（Phase 3、Webセキュリティ／クレデンシャル・スタッフィング） |
| ES   | 2024 春 | 記述式 | 1 大問（5設問） | キュレーション完了（Phase 3、リアルタイム制御／RTOS） |
| PM   | 2024 春 | 論述式 | 1 大問（設問ア・イ・ウ） | キュレーション完了（Phase 3、不確実性の高い要求への対応） |
...
- [ ] FE 午後（記述式相当の科目B拡張は要確認）※Phase 2 別ブランチで対応中
- [ ] DB 午後I（記述式）※Phase 2 別ブランチで対応中
- [ ] NW 午後I（記述式）※Phase 2 別ブランチで対応中
- [x] SC 午後（記述式）— Phase 3 完了
- [x] ES 午後I（記述式）— Phase 3 完了
...
- [x] PM 午後II（プロジェクトマネジメント）— Phase 3 完了
- [ ] SA 午後II（システムアーキテクト）
- [ ] AU 午後II（システム監査）
