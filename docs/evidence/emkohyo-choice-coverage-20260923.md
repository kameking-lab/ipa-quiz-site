...
9月24日の次バッチ選定（`scripts/emkohyo-review-candidates.py`、読み取り専用、上限20問）では選定0問、公開受入の増分は0（109/360のまま）。未受入251問の内訳は、未草稿60問、草稿reviewIssues残存186問、現草稿hashに一致する欠落0の政府資料packなし2問（2025有機Q1は単問・3問packの`draftSha256`が古く、5問packは同一バッチのQ4・Q5が`missingEvidenceQuestions`。2025-07のQ1は単問packの`draftSha256`が古く、5問packもhashが古いうえQ1自身が`missingEvidenceQuestions`）。資料が揃う残り3問（EM20261804-q8、EM20251807-q5、EM20251807-q7）には、現候補hashに対する`claude-opus-5-5`のFIX receiptが既にあるため、HOLDのまま再審査しない。同じ候補をそのまま再審査するのは判定の引き直しに当たる。各receiptのreasonIssues・sourceIssues・needsExternalCheckを解消した改稿と、それを直接支える政府一次資料packの再固定が先に必要。判定と保留理由は`emkohyo-choice-sources/review-candidates-20260924.json`に固定した。受入pin検証は109/109、`--require-explanations`はPASS、`--require-em-two-years`は未完了のため引き続き失敗（360/360ゲートはfalse）。
