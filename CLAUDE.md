...
料金戦略はユーザー獲得最優先・持ち出し最小。月 980 円で広告収益モデルと予備校との間を切り崩す。
...
- **フェーズ1（完了済み：MVP）**: AP 午前 + クイズ UX + AI コパイロット + 無料 50 回/日 制限
...
無料プラン（ユーザー獲得最優先）:
- 全試験・全機能アクセス無制限
- AI コパイロット: 1 日 50 回（JST 0:00 リセット）
- 広告表示あり（本文と分離、控えめ）
