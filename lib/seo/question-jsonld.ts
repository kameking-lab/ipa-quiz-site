...
export function buildQuestionJsonLd({
  ...
  const questionAuthor = (q.exam === "fp2" || q.exam === "fp3")
    ...
    : q.exam === "civil2" || q.exam === "kankoji2" || q.exam === "civil1" || q.exam === "zoen2" || q.exam === "tsushin2"
      ? {
          "@type": "Organization",
  ...
  const licenseUrl = (q.exam === "fp2" || q.exam === "fp3")
    ...
    : q.exam === "takken" || q.exam === "civil1" || q.exam === "civil2" || q.exam === "kankoji2" || q.exam === "zoen2" || q.exam === "tsushin2" || q.exam === "kaigo" || q.exam === "denken2" || q.exam === "denko1" || q.exam === "shakai" || q.exam === "seishin" || q.exam === "tohan"
      ? undefined
