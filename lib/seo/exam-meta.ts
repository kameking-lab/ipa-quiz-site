...
export const EXAM_DESCRIPTIONS: Partial<Record<ExamCode, string>> = {
  ...
  takken: "宅地建物取引士資格試験の2025年度公式過去問を、各選択肢の理由と2025年4月1日の法令基準日付きで学べます。",
  civil2: "2級土木施工管理技術検定の令和8年度第一次検定（前期・土木）からNo.6〜16の11問を収録。公式問題・正答と全選択肢の学習用解説を確認できます。全66問中の一部です。",
};
...
> = {
  ...
  takken: (c, y, k) =>
    `宅地建物取引士資格試験の公式過去問${c}問を${y}期・${k}分野に整理。各選択肢の正誤理由、公式問題と正解番号、2025年4月1日時点の法令基準日を確認しながら学べます。`,
  civil2: (c, y, k) =>
    `2級土木施工管理技術検定の令和8年度第一次検定（前期・土木）の選択群No.6〜16を${c}問・${y}期分・${k}分野収録。公式問題・正答と全選択肢の理由を確認できます。全66問中の一部です。`,
};
