...
export const EXAM_DESCRIPTIONS: Partial<Record<ExamCode, string>> = {
  ...
  civil2: "2級土木施工管理技術検定の令和8年度前期全66問と令和7年度10月実施分の照合済み42問を収録。公式問題・正答と全選択肢の学習用解説を確認できます。",
};
...
> = {
  ...
  civil2: (c, y, k) =>
    `2級土木施工管理技術検定の令和8年度前期全66問と令和7年度10月実施分の照合済み42問を含む${c}問・${y}期分・${k}分野を収録。公式問題・正答と全選択肢の理由を確認できます。`,
};
