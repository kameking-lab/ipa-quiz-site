...
export const EXAM_DESCRIPTIONS: Partial<Record<ExamCode, string>> = {
  ...
  kaigo: "介護福祉士国家試験の第38回（令和7年度）全125問を、公式問題文のまま収録。総合問題の事例文と図の問題も含み、公式正答と全選択肢の学習用解説（試験センターとは無関係の独自解説）を確認できます。",
};
...
> = {
  ...
  kaigo: (c, y, k) =>
    `介護福祉士国家試験の第38回（令和7年度）を${c}問・${y}回分・${k}科目で収録。問題文は公式PDFの原文のまま、公式正答と全選択肢の学習用解説を確認できます。解説は試験センターとは関係のない独自作成です。`,
};
