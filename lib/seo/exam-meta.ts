...
export const EXAM_DESCRIPTIONS: Partial<Record<ExamCode, string>> = {
  ...
  denken2: "第二種電気主任技術者試験の一次試験（令和8年度）から電力・法規の2科目を収録。空欄ごとに15肢の解答群から選び、全肢の理由と公式問題・正答を確認できます。",
  denko2: "第二種電気工事士学科試験の2024・2025年度上下期を全200問収録。各選択肢の正誤理由と公式問題・正答を確認できます。技能試験104課題も試験日別に掲載しています。",
  denko1: "第一種電気工事士学科試験の令和8年度上期(CBT)の公表出題例 全50問を収録。高圧受電設備の配線図問題を含み、各選択肢の正誤理由と公式問題・正答を確認できます。",
  ...
  kankoji2: "2級管工事施工管理技術検定の令和8年度前期と令和7年度後期の第一次検定を各全52問収録。公式問題・正答、図表、全選択肢の学習用解説を確認できます。「二つとも答えなさい」の問題も2肢を選んで採点します。",
  zoen2: "2級造園施工管理技術検定の令和8年度前期第一次検定から、公式問題・正答と照合した設問を収録。40問中の公開済み設問を解説付きで学べます。未収録の問題は順次確認します。",
  zoen1: "1級造園施工管理技術検定の令和8年度第一次検定の問題A・Bから、公式問題・正答と照合した公開済み設問を解説付きで学べます。実試験では問題A36問・問題B29問が全て必須です。",
  tsushin2: "2級電気通信工事施工管理技術検定の令和8年度前期第一次検定から、公式問題・正答と照合した設問を収録。65問中の公開済み設問を解説付きで学べます。未収録の問題は順次確認します。",
  tsushin1: "1級電気通信工事施工管理技術検定の令和8年度第一次検定の問題A・Bから、公式問題・正答と照合した収録済み設問を解説付きで学べます。実試験は全90問から条件に従って60問を解答します。",
  kaigo: "介護福祉士国家試験の第38回（令和7年度）全125問を収録。総合問題の事例文と図の問題も含み、公式問題・正答と全選択肢の学習用解説を確認できます。",
  civil1: "1級土木施工管理技術検定の令和8年度（7月実施）第一次検定を収録。問題A全66問と問題B 34問で、公式問題・正答、図表、全選択肢の学習用解説を確認できます。",
  shakai: "社会福祉士国家試験の第38回（令和7年度）全129問（共通科目84問・専門科目45問）を収録。「2つ選びなさい」の問題も2肢そろえて採点し、公式問題・正答と全選択肢の学習用解説を確認できます。",
  seishin: "精神保健福祉士国家試験の第28回（令和7年度）専門科目48問と共通科目84問を収録。公式問題・正答と全選択肢の学習用解説を確認できます。",
...
const EXAM_FULL_NAMES: Record<ExamCode, string> = {
  ...
  denken2: "第二種電気主任技術者試験 一次試験",
  denko2: "第二種電気工事士学科試験",
  denko1: "第一種電気工事士学科試験",
  takken: "宅地建物取引士資格試験",
  civil2: "2級土木施工管理技術検定",
  kankoji2: "2級管工事施工管理技術検定",
    zoen2: "2級造園施工管理技術検定",
    zoen1: "1級造園施工管理技術検定",
  tsushin2: "2級電気通信工事施工管理技術検定",
  tsushin1: "1級電気通信工事施工管理技術検定",
  kaigo: "介護福祉士国家試験",
  civil1: "1級土木施工管理技術検定",
  shakai: "社会福祉士国家試験",
  seishin: "精神保健福祉士国家試験",
...
> = {
  ...
  denken2: (c) =>
    `第二種電気主任技術者一次試験の令和8年度公式過去問から電力・法規の2科目・${c}空欄を収録（理論・機械は未収録）。空欄ごとに公式の解答群15肢から選び、全肢の理由と公式問題・正答のリンクを確認できます。`,
  denko2: (c, y, k) =>
    `第二種電気工事士学科の2024・2025年度上下期を${c}問・${y}期分・${k}分野収録。全選択肢の正誤理由と公式問題・正答を確認できます。技能試験104課題も試験日別に掲載しています。`,
  denko1: (c, y, k) =>
    `第一種電気工事士学科の令和8年度上期(CBT)公表出題例を${c}問・${y}期分・${k}分野収録。高圧受電設備の配線図を含む全選択肢の正誤理由と、公式問題・正答を確認できます。`,
  takken: (c, y, k) =>
  ...
  kankoji2: (c, y, k) =>
    `2級管工事施工管理技術検定の令和8年度前期と令和7年度後期の第一次検定を${c}問・${y}期分・${k}分野収録。公式問題・正答、図表、全選択肢の理由を確認でき、二つ選ぶ問題も本試験どおり採点します。`,
  zoen2: (c, y, k) =>
    `2級造園施工管理技術検定の令和8年度前期第一次検定から${c}問・${y}期分・${k}分野を収録。公式問題・正答と全選択肢の解説を確認できます。公式の40問中、確認済みの設問を掲載しています。`,
  zoen1: (c, y, k) =>
    `1級造園施工管理技術検定の令和8年度第一次検定・問題A/Bから${c}問・${y}期分・${k}分野を収録。公式問題・正答と全選択肢の解説を確認できます。公式の65問中、確認済みの設問を掲載しています。`,
  tsushin2: (c, y, k) =>
    `2級電気通信工事施工管理技術検定の令和8年度前期第一次検定から${c}問・${y}期分・${k}分野を収録。公式問題・正答と全選択肢の解説を確認できます。公式の65問中、確認済みの設問を掲載しています。`,
  tsushin1: (c, y, k) =>
    `1級電気通信工事施工管理技術検定の令和8年度第一次検定・問題A/Bから${c}問・${y}期分・${k}分野を収録。公式問題・正答と全選択肢の解説を確認できます。公式の90問中、確認済みの設問を掲載しています。`,
  kaigo: (c, y, k) =>
    `介護福祉士国家試験の第38回（令和7年度）を${c}問・${y}回分・${k}科目で収録。総合問題・図の問題も含め、公式問題・正答と全選択肢の学習用解説を確認できます。`,
  civil1: (c, y, k) =>
    `1級土木施工管理技術検定の令和8年度（7月実施）第一次検定を問題A・問題Bあわせて${c}問・${y}期分・${k}分野収録。公式問題・正答、図表、全選択肢の理由を確認できます。`,
  shakai: (c, y, k) =>
    `社会福祉士国家試験の第38回（令和7年度）を${c}問・${y}回分・${k}科目で収録。共通科目・専門科目とも公式問題・正答と全選択肢の学習用解説を確認でき、「2つ選びなさい」は2肢そろえて採点します。`,
  seishin: (c, y, k) =>
    `精神保健福祉士国家試験の第28回（令和7年度）を${c}問・${y}回分・${k}科目で収録。専門科目と共通科目の公式問題・正答と全選択肢の学習用解説を確認できます。`,
  tohan: (c, y, k) =>
