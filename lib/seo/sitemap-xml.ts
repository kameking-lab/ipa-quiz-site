...
const STATIC_ROUTES: UrlEntry[] = [
  ...
  { url: `${SITE_BASE_URL}/quickstart`, lastModified: STATIC_CONTENT_DATE, changeFrequency: "monthly", priority: 0.8 },
  { url: `${SITE_BASE_URL}/quickstart/ip`, lastModified: STATIC_CONTENT_DATE, changeFrequency: "monthly", priority: 0.7 },
  { url: `${SITE_BASE_URL}/quickstart/fe`, lastModified: STATIC_CONTENT_DATE, changeFrequency: "monthly", priority: 0.7 },
  { url: `${SITE_BASE_URL}/quickstart/ap`, lastModified: STATIC_CONTENT_DATE, changeFrequency: "monthly", priority: 0.7 },
  { url: `${SITE_BASE_URL}/quickstart/sc`, lastModified: STATIC_CONTENT_DATE, changeFrequency: "monthly", priority: 0.7 },
