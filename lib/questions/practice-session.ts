...
export const PRACTICE_SESSIONS: readonly Session[] = ["am", "am1", "am2", "kamoku-a", "kamoku-b", "gakka", "riron", "denryoku", "kikai", "houki", "mondai-a", "mondai-b"];
...
export function defaultPracticeSession(exam: ExamCode, year?: number): Session {
  ...
  if (exam === "fp2" || exam === "fp3" || exam === "denko2" || exam === "takken" || exam === "civil2" || exam === "kankoji2" || exam === "kaigo") return "gakka";
  if (exam === "civil1") return "mondai-a";
...
export function practiceSessionLabel(session: Session): string {
  return ({ am: "午前", am1: "午前I（共通）", am2: "午前II（専門）", "kamoku-a": "科目A", "kamoku-b": "科目B", pm: "午後", pm1: "午後I", pm2: "午後II", gakka: "学科", riron: "理論", denryoku: "電力", kikai: "機械", houki: "法規", "mondai-a": "問題A", "mondai-b": "問題B" })[session];
}
