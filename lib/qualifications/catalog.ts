...
export const QUALIFICATION_CATALOG: readonly QualificationCatalogEntry[] = [
  ...
  },
  {
    ...
    remainingWork: ["CBT公表問題の文字起こし", "各肢解説の根拠確認", "問題数が揃った段階で公開"],
  },
  {
    slug: "denken3",
    examCode: "denken3",
    ...
    remainingWork: ["公式FAQの案内に従い利用状況をメール連絡", "理論以外の3科目を追加", "数式・図をSVGまたはアクセシブルなテキストへ変換"],
  },
  {
    slug: "denko2",
    shortName: "第二種電気工事士",
    ...
    remainingWork: ["器具写真の権利と表示方法を問題単位で確認", "学科問題の文字起こしと各肢解説"],
  },
  {
  ...
  },
  {
    ...
    status: "permission-required",
    reuseSummary: "問題・正解番号は公式公開されるが、私的使用・適法な引用を除く無断転載を禁止。",
    remainingWork: ["Web問題集への全文転載許諾を取得", "法改正による陳腐化を年度単位で表示する設計"],
  },
  {
    slug: "gyoseishoshi",
    shortName: "行政書士",
