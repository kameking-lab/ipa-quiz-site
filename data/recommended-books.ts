...
export const RECOMMENDED_BOOKS: Record<ExamCode, RecommendedBook[]> = {
  ip: [
    ...
    },
    {
      ...
      tags: ["問題集", "短期集中"],
      difficulty: "beginner",
      recommendedFor: "テキストは別で持っていて演習量を増やしたい人",
      description:
        "TAC講師陣による問題演習特化本。スマートフォン学習を意識した分冊・赤シート対応で、隙間時間に強い。",
    },
  ],
  ...
  sg: [
    {
      ...
      tags: ["教科書", "定番", "解説詳細"],
      difficulty: "beginner",
      recommendedFor: "セキュリティ初学者・体系的に学びたい人",
      description:
        "支援士の定番著者・上原氏によるSG向け体系本。試験範囲を漏れなく押さえつつ、現場で使える知識まで一気に整理できる。",
    },
    {
      id: "sg-okajima",
    ...
    {
      id: "sg-spec-text",
      title: "ニュースペックテキスト 情報セキュリティマネジメント",
      author: "TAC情報処理講座",
      publisher: "TAC出版",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
  ...
  fe: [
    ...
    {
      id: "fe-uchida-algo",
      title: "出るとこだけ！基本情報技術者[科目B]アルゴリズム×擬似言語",
      author: "矢沢 久雄",
      publisher: "翔泳社",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
  ...
  ap: [
    ...
    },
    {
      ...
      tags: ["教科書一体型", "問題集"],
      difficulty: "intermediate",
      recommendedFor: "一冊で完結させたい人",
      description:
        "教科書と問題集が一体化したオールインワン。一冊で完結させたい多忙な社会人受験者向け。",
    },
  ],
  ...
  sc: [
    ...
    {
      id: "sc-juten",
      title: "情報処理安全確保支援士 専門知識＋午後問題の重点対策",
      author: "三好 康之",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
    ...
    {
      id: "sc-itec-text",
      title: "情報処理安全確保支援士 試験対策書",
      author: "アイテックIT人材教育研究部",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
      rakutenId: PLACEHOLDER_RAKUTEN,
  ...
  nw: [
    ...
    {
      id: "nw-juten",
      title: "ネットワークスペシャリスト 「専門知識＋午後問題」の重点対策",
      author: "長谷 和幸",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
  ...
  db: [
    ...
    {
      id: "db-juten",
      title: "データベーススペシャリスト 「専門知識＋午後問題」の重点対策",
      author: "山平 努",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
  ...
  es: [
    {
      id: "es-fukushima",
      title: "情報処理教科書 エンベデッドシステムスペシャリスト",
      author: "福嶋 宏訓",
      publisher: "翔泳社",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
    ...
    {
      id: "es-juten",
      title: "エンベデッドシステムスペシャリスト 「専門知識＋午後問題」の重点対策",
      author: "藤田 政博",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
    ...
    {
      id: "es-pocket-study",
      title: "ポケットスタディ エンベデッドシステムスペシャリスト",
      author: "村山 直紀",
      publisher: "秀和システム",
      year: 2023,
      asin: PLACEHOLDER_ASIN,
      ...
      tags: ["ハンディ", "暗記"],
      difficulty: "advanced",
      recommendedFor: "通勤学習・直前期",
      description:
        "ES頻出論点をハンディに圧縮。教材が少ないESで貴重な総まとめ本。",
    },
    {
      id: "es-itec-textbook",
      title: "ALL IN ONE エンベデッドシステムスペシャリスト",
      author: "アイテック",
      publisher: "アイテック",
      year: 2023,
      asin: PLACEHOLDER_ASIN,
  ...
  st: [
    ...
    {
      id: "st-juten",
      title: "ITストラテジスト 「専門知識＋午後問題」の重点対策",
      author: "満川 一彦",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
    ...
    {
      id: "st-allinone",
      title: "ALL IN ONE パーフェクトマスター ITストラテジスト",
      author: "TAC情報処理講座",
      publisher: "TAC出版",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
  ...
  sa: [
    ...
    {
      id: "sa-juten",
      title: "システムアーキテクト 「専門知識＋午後問題」の重点対策",
      author: "岡山 昌二",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
    ...
    {
      id: "sa-allinone",
      title: "ALL IN ONE パーフェクトマスター システムアーキテクト",
      author: "TAC情報処理講座",
      publisher: "TAC出版",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
  ...
  pm: [
    ...
    {
      id: "pm-juten",
      title: "プロジェクトマネージャ 「専門知識＋午後問題」の重点対策",
      author: "岡山 昌二",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
    ...
    {
      id: "pm-ronbun",
      title: "プロジェクトマネージャ 合格論文の書き方・事例集",
      author: "岡山 昌二",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
    ...
    {
      id: "pm-allinone",
      title: "ALL IN ONE パーフェクトマスター プロジェクトマネージャ",
      author: "TAC情報処理講座",
      publisher: "TAC出版",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
  ...
  sm: [
    ...
    {
      id: "sm-juten",
      title: "ITサービスマネージャ 「専門知識＋午後問題」の重点対策",
      author: "長嶋 仁",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
    ...
    {
      id: "sm-ronbun",
      title: "ITサービスマネージャ 合格論文の書き方・事例集",
      author: "岡山 昌二",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
    ...
    {
      id: "sm-allinone",
      title: "ALL IN ONE パーフェクトマスター ITサービスマネージャ",
      author: "TAC情報処理講座",
      publisher: "TAC出版",
      year: 2023,
      asin: PLACEHOLDER_ASIN,
  ...
  au: [
    ...
    {
      id: "au-juten",
      title: "システム監査技術者 「専門知識＋午後問題」の重点対策",
      author: "落合 和雄",
      publisher: "アイテック",
      year: 2024,
      asin: PLACEHOLDER_ASIN,
    ...
    {
      id: "au-allinone",
      title: "ALL IN ONE パーフェクトマスター システム監査技術者",
      author: "TAC情報処理講座",
      publisher: "TAC出版",
      year: 2023,
      asin: PLACEHOLDER_ASIN,
