...
export const KEYWORD_PAGES: KeywordPage[] = [
  ...
  {
    slug: "cpu-seinou-keisan",
    title:
      "CPU 性能の計算の解き方｜クロック周波数・CPI・命令実行時間・MIPS",
    description:
      "基本情報・応用情報の午前で頻出する CPU 性能の計算を、クロック周波数とクロック周期の関係・CPI（1 命令あたりのクロック数）・命令実行時間・MIPS の求め方・平均 CPI の重み付き平均まで段階的に解説します。練習問題付き。",
    exams: ["ap", "fe"],
    relatedTopics: ["コンピュータ構成", "性能設計", "基礎理論"],
    body: [
  ...
  {
    slug: "johoryo-huffman-keisan",
    title:
      "情報量・エントロピーの計算の解き方｜log₂・平均情報量・ハフマン符号の平均符号長",
    description:
      "基本情報・応用情報の午前で頻出する情報量の計算を、選択情報量＝log₂（場合の数）・平均情報量（エントロピー）・ハフマン符号化の平均符号長（重み付き平均）まで段階的に解説します。練習問題付き。",
    exams: ["ap", "fe"],
    relatedTopics: ["情報理論", "符号化", "基礎理論"],
    body: [
  ...
  {
    slug: "fukushousuten-gosa-keisan",
    title:
      "浮動小数点の誤差の解き方｜丸め誤差・打切り誤差・桁落ち・情報落ちの見分け方",
    description:
      "基本情報・応用情報の午前で頻出する浮動小数点の誤差を、浮動小数点表現（符号部・指数部・仮数部）と正規化・丸め誤差／打切り誤差／桁落ち／情報落ちの 4 つの違いと見分け方まで段階的に解説します。練習問題付き。",
    exams: ["ap", "fe"],
    relatedTopics: ["浮動小数点", "データ表現", "基礎理論"],
    body: [
