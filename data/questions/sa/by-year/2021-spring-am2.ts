...
export const SA_QUESTIONS_2021_SPRING_AM2: Question[] = [
  ...
  },
  {
    ...
    "answer": "ア",
    "explanation": "判定条件網羅（分岐網羅）では、プログラム中の各判定条件において、「真」となるパスと「偽」となるパスの両方を少なくとも一度は実行するテストケースを作成します。問題文の「処理1 A > 6 or B = 0 Yes No 処理2」という判定条件に着目します。\n\nアの選択肢（A=1, B=1）では、「A > 6」は偽、「B = 0」も偽となり、論理和「A > 6 or B = 0」全体が偽となります。次に（A=7, B=1）では、「A > 6」は真となり、論理和全体が真となります。このように、アは「偽」と「真」の両方の結果を網羅しているため適切です。\n\nイの選択肢（A=4, B=0）では、「A > 6」は偽、「B = 0」は真となり、論理和全体が真となります。一方、（A=8, B=1）では、「A > 6」は真となり、論理和全体が真となります。これは真のパスのみを網羅しており、偽のパスを網羅していません。\nウの選択肢（A=4, B=1）では、「A > 6」は偽、「B = 0」も偽となり、論理和全体が偽となります。しかし、（A=6, B=1）では、「A > 6」は偽、「B = 0」も偽となり、論理和全体が偽となります。これも偽のパスのみを網羅しており、真のパスを網羅していません。\nエの選択肢（A=7, B=1）では、「A > 6」は真となり、論理和全体が真となります。また、（A=1, B=0）では、「B = 0」が真となり、論理和全体が真となります。これは真のパスのみを網羅しており、偽のパスを網羅していません。",
    "hasImage": true,
    "sourcePdfUrl": "https://www.jitec.ipa.go.jp/1_04hanni_sukiru/mondai_kaitou_2021h03_1/2021h03h_sa_am2_qs.pdf",
    "license": "IPA-public"
  },
  ...
  },
  {
    ...
    "answer": "イ",
    "explanation": "イが正解となるのは、開発方針と開発モデルの定義に基づきます。\n\n開発方針a「最初にコア部分を開発し、順次機能を追加していく」は、段階的に製品を完成させていく「段階的モデル（Incremental Model）」に合致します。\n開発方針b「要求が明確なので、全機能を一斉に開発する」は、計画通りに各工程を順次進める「ウォータフォールモデル（Waterfall Model）」の典型的な進め方です。\n開発方針c「要求に不明確な部分があるので、開発を繰り返しながら徐々に要求内容を洗練していく」は、試作と評価を繰り返して製品を改良していく「進化的モデル（Evolutionary Model）」に該当します。\n\nアは、開発方針aが段階的モデルではなく進化的モデルとなっているため不適切です。\nウは、開発方針aが段階的モデルではなくウォータフォールモデルとなっているため不適切です。\nエは、開発方針bが段階的モデルではなくウォータフォールモデルとなっているため不適切です。",
    "hasImage": true,
    "sourcePdfUrl": "https://www.jitec.ipa.go.jp/1_04hanni_sukiru/mondai_kaitou_2021h03_1/2021h03h_sa_am2_qs.pdf",
    "license": "IPA-public"
  },
