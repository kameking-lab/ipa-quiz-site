...
export const ST_QUESTIONS_2025_SPRING_AM2: Question[] = [
  ...
  },
  {
    ...
    "answer": "イ",
    "explanation": "マーケティング活動は、環境分析、市場細分化、標的市場の選定、ポジショニング、マーケティングミックスの開発、実行という順序で進みます。図のdはポジション決定の後、実行計画策定の前にあるため、マーケティングミックス決定であるイが正解です。選んだ市場で自社の製品を競合に対してどのように位置付けるかを定め、その位置付けに合う製品・価格・流通・販促を組み合わせます。",
    "hasImage": true,
    "imageUrls": [
  ...
  },
  {
    ...
    "answer": "ウ",
    "explanation": "不協和低減型は、製品への関わりが高い一方でブランド間の違いを知覚しにくい、図の左下の型です。ブランドを見分けられないまま購入し、購入後にブランドを評価して後悔を感じやすい行動なので、ウが正解です。アは右上のバラエティシーキング型、イは右下の習慣購買型、エは左上の複雑な購買行動型に対応します。",
    "hasImage": true,
    "imageUrls": [
  ...
  },
  {
    ...
    "answer": "イ",
    "explanation": "魔の川は、基礎研究などの研究成果を具体的な製品・サービスの開発につなげる際の障壁を指すため、イが正解です。開発から事業化への障壁は死の谷、事業化後に市場競争を勝ち抜いて事業を存続させる障壁はダーウィンの海と呼ばれます。研究から開発への移行と、量産や市場での成功を区別します。",
    "hasImage": false,
    "sourcePdfUrl": "https://www.ipa.go.jp/shiken/mondai-kaiotu/nl10bi0000009lh8-att/2025r07h_st_am2_qs.pdf",
    "license": "IPA-public"
  },
  ...
  },
  {
    ...
    "answer": "エ",
    "explanation": "フェアユースは米国著作権法107条の考え方で、著作物の一定の利用を著作権侵害としない法理です。利用の目的・性質、著作物の性質、利用部分の量・重要性、市場又は価値への影響という4要素などを総合的に考慮します。該当するエが正解です。教育・批評目的などであっても自動的に全ての利用が認められるわけではありません。",
    "hasImage": false,
    "sourcePdfUrl": "https://www.ipa.go.jp/shiken/mondai-kaiotu/nl10bi0000009lh8-att/2025r07h_st_am2_qs.pdf",
    "license": "IPA-public"
  },
  ...
  },
  {
    ...
    "answer": "ウ",
    "explanation": "JPCERT/CCのCSIRTガイドでは、コーディネーションセンターは複数組織の連携調整、分析センターはインシデントの傾向分析、マルウェア解析、攻撃活動の痕跡の分析、ベンダーチームは自社製品の脆弱性等への対応、インシデントレスポンスプロバイダは顧客への対応サービスを担当します。表の役割にこれらを対応させたウが正解です。",
    "hasImage": true,
    "imageUrls": [
