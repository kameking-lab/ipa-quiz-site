    ...
    subPrompts: [
      {
        ...
        scoringPoints: [
          "設問イの可用性施策につながる SLA / SLO が具体的な目標値で示されているか",
          "サービス特性に固有の前提か（一般論でないか）",
        ],
      },
      {
        key: "イ",
        ...
        requiredKeywords: [
          "冗長化／フェイルオーバ",
          "監視（Synthetic／RUM）",
          "障害対応プロセス（検知→切分け→復旧→事後分析）",
          "再発防止（PIR／構成変更）",
        ],
        scoringPoints: [
          "机上のフレームワーク列挙でなく、実サービス特性に応じた可用性設計か",
          "障害対応プロセスが検知から事後分析まで体系的に一貫しているか",
          "施策が設問アの SLA / SLO 目標と対応づいているか",
        ],
      },
      {
        key: "ウ",
        ...
        scoringPoints: [
          "評価が設問アの SLA / SLO に対する達成度として示されているか",
          "想定外障害への主体的な対応・教訓が具体的か",
        ],
      },
    ],
    ...
    subPrompts: [
      {
        ...
        requiredKeywords: [
          "IT サービス概要",
          "インシデントの発生状況（時刻/事象）",
          "業務影響（停止時間/影響利用者数/金銭的損失）",
        ],
        scoringPoints: [
          "業務影響が定量的に示されているか",
          "設問イの対応につながるインシデントの深刻度が伝わるか",
        ],
      },
      {
        key: "イ",
        ...
        requiredKeywords: [
          "初動対応（インシデントコマンダ任命/暫定対応）",
          "エスカレーション・関係者連絡（経営/業務部門/顧客）",
          "根本原因特定（ログ分析/再現テスト）",
          "暫定対応と恒久対応の切り分け",
        ],
        scoringPoints: [
          "初動の迅速性と関係者連絡の網羅性が示されているか",
          "根本原因分析が論理的か（憶測でないか）",
          "暫定対応と恒久対応を切り分けて判断しているか",
        ],
      },
      {
        key: "ウ",
        ...
        requiredKeywords: [
          "再発防止策（技術対策/プロセス改善/教育）",
          "効果検証方法",
          "組織展開（ポストモーテム共有/ガイドライン更新）",
        ],
        scoringPoints: [
          "個人技でなく、組織的な仕組みで再発を防ぐ視点があるか",
          "再発防止策が設問イで特定した根本原因に対応づいているか",
          "効果検証の方法が具体的か",
        ],
      },
    ],
