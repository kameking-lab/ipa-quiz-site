...
export const metadata: Metadata = {
  ...
  description: "日本FP協会公表のFP2級実技試験を2024年・2025年の4回分、160問収録。設問と公式模範解答を回ごとに確認できます。",
...
export default function Fp2PracticalHome() {
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 sm:py-12">
      ...
      <p className="mt-3 leading-relaxed text-muted-foreground">日本FP協会が公表した2024年・2025年の全4回、各40問。計算、複数の空欄、○×問題も公式模範解答の単位と組合せを保って掲載しています。</p>
      <div className="mt-3 flex flex-wrap gap-2 text-sm text-muted-foreground"><span>4回分</span><span>・</span><span>160問</span></div>
