    ...
    <main className="relative flex-1">
      ...
      <div className="relative mx-auto w-full max-w-3xl px-4 pb-20 pt-6 sm:px-6 sm:pt-10">
        ...
        <header className="mb-6">
          ...
          {code === "civil2" && <p className="mt-3 text-sm text-muted-foreground">令和8年度前期の第一次検定（土木）全66問と令和7年度10月実施分のNo.6〜47を収録。実試験ではNo.1〜5とNo.48〜66が必須、No.6〜16から9問、No.17〜36から6問、No.37〜47から6問を選びます。演習では公開済みの問題を自由に解けます。</p>}
        </header>
