...
const OG_IMAGE = `${SITE_BASE_URL}/api/og?${new URLSearchParams({
  type: "blog",
  title: "IPA試験 学習ケース（架空）",
  subtitle: "13区分の架空の学習ケース",
  body: "IPA情報処理技術者試験13区分の架空の学習ケース。勉強法・つまずき・突破方法を職種別の設定で紹介。",
}).toString()}`;

export const metadata: Metadata = {
  title: "IPA試験 学習ケース（架空）｜13区分の架空の学習ケース集",
  description:
    "IPA情報処理技術者試験13区分の架空の学習ケース。営業・事務・エンジニア・主婦・学生など多様な職種・年齢の合格までの勉強法・つまずき・突破方法を参考例として紹介。",
  alternates: { canonical: "/success-stories" },
  // 致命傷③: AI生成の架空ペルソナ集なので検索インデックス対象外にする。
  robots: { index: false, follow: false },
  openGraph: {
    title: "IPA試験 学習ケース（架空） | 過去問AI",
    description:
      "13区分の架空の学習ケース。職種・年齢・学習期間別に勉強法と突破方法を紹介。",
    url: `${SITE_BASE_URL}/success-stories`,
    type: "website",
    siteName: SITE_NAME,
    locale: "ja_JP",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "IPA試験 学習ケース（架空）" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "IPA試験 学習ケース（架空） | 過去問AI",
    description: "13区分の架空の学習ケース。職種・年齢別の勉強法と突破方法。",
    images: [OG_IMAGE],
  },
};
    ...
    <main className="mx-auto w-full max-w-4xl px-4 py-6 sm:py-10">
      ...
      <header className="mb-10">
        ...
        <p className="mt-3 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300 sm:text-base">
          IPA 情報処理技術者試験 13 区分の架空の学習ケースコレクション。
          営業・事務・エンジニア・主婦・学生など多様な職種・年齢の合格までの勉強法・つまずき・突破方法を参考例として紹介します。
      ...
      <section className="mt-12 rounded-2xl border border-sky-200 bg-sky-50/60 p-5 text-sm text-zinc-700 dark:border-sky-800 dark:bg-sky-950/30 dark:text-zinc-300">
        ...
        <p className="leading-relaxed">
          ケースを読み終わったら、自分の挑戦を始めましょう。過去問AI は 13 区分・{APPROX_QUESTION_COUNT_LABEL} 問超を AI コパイロット付きで学習できます。
        </p>
